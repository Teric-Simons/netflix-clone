        ...
        <svg width="72" height="72" viewBox="0 0 48 48" fill="none">
          <g id="tv-mobile-core-small">
            <path
              ...
              fill="url(#paint0_radial_4819_621)"
            ></path>
            <path
              id="Vector_2"
              ...
              fill="url(#paint1_radial_4819_621)"
            ></path>
            <path
              id="Vector_3"
              d="M39.1999 8.80011H5.59985V31.6001H39.1999V8.80011Z"
              fill="url(#paint2_linear_4819_621)"
            ></path>
            <path
              id="Vector_4"
              d="M39.1999 8.80011H5.59985V31.6001H39.1999V8.80011Z"
              fill="url(#paint3_linear_4819_621)"
              fill-opacity="0.5"
            ></path>
            <path
              id="Vector_5"
              ...
              fill="url(#paint4_radial_4819_621)"
            ></path>
            <path
              id="Vector_6"
              ...
              fill="url(#paint5_radial_4819_621)"
            ></path>
            <path
              id="Vector_7"
              opacity="0.5"
              d="M30.4001 33.2001H37.6001L34.8001 26.8001L30.4001 33.2001Z"
              fill="url(#paint6_radial_4819_621)"
            ></path>
            <path
              id="Vector_8"
              opacity="0.5"
              ...
              fill="url(#paint7_linear_4819_621)"
            ></path>
            <path
              id="Vector_9"
              ...
              fill="url(#paint8_linear_4819_621)"
            ></path>
            <path
              id="Vector_10"
              ...
              stroke="url(#paint9_linear_4819_621)"
              stroke-width="0.8"
            ></path>
            <path
              id="Vector_11"
              d="M32.2 41.2L35.4 26L42.8 27.2L39.6 42.4L32.2 41.2Z"
              fill="url(#paint10_linear_4819_621)"
            ></path>
            <path
              id="Vector_12"
              d="M32.2 41.2L35.4 26L42.8 27.2L39.6 42.4L32.2 41.2Z"
              fill="url(#paint11_linear_4819_621)"
              fill-opacity="0.5"
            ></path>
            <path
              id="Vector_13"
            ...
            <path
              id="Vector_14"
              d="M37.5999 27.3997L40.1999 27.7997"
              stroke="#1C0E20"
              stroke-width="0.8"
    ...
    <div className="more-reasonsContainer">
      ...
      <div className="reasonFlex">
        {boxes.map((box) => (
          <div className="box">
            <p>{box.text}</p>
            <div style={{ textAlign: "right" }}>{box.svg}</div>
          </div>
        ))}
      </div>
    </div>
