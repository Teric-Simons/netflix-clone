...
const MovieSlider = () => {
  ...
  useEffect(() => {
    let interval;
    if (active) {
      if(currentIndex == 1){progress.bar1 = 101};
      if(currentIndex == 2){progress.bar1 = 101;progress.bar2 = 101};
  ...
  return (
    <>
      <div className="movie-scrollView">
        ...
        <button onClick={e=>{goToPrevious(); setActive(false)
        ...
        <button onClick={e=>{goToNext(); setActive(false)}}
      ...
      <div className="loading-bars">
        ...
        >
          {active?(<button data-uia="carousel-nav-pause" aria-label="Pause" class="default-ltr-cache-1bxcol5"><svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 24 24" width="24" height="24" data-icon="PauseStandard" aria-hidden="true" class="default-ltr-cache-u5jcjm e1eegyml2"><path fill-rule="evenodd" clip-rule="evenodd" d="M4.5 3C4.22386 3 4 3.22386 4 3.5V20.5C4 20.7761 4.22386 21 4.5 21H9.5C9.77614 21 10 20.7761 10 20.5V3.5C10 3.22386 9.77614 3 9.5 3H4.5ZM14.5 3C14.2239 3 14 3.22386 14 3.5V20.5C14 20.7761 14.2239 21 14.5 21H19.5C19.7761 21 20 20.7761 20 20.5V3.5C20 3.22386 19.7761 3 19.5 3H14.5Z" fill="currentColor"></path></svg></button>):(  <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            role="img"
            viewBox="0 0 24 24"
